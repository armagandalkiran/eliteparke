...
export default function Products() {
    return (
        <div>
            <div className="product-main__image bg-cover bg-center h-auto mb-8 md:mb-24 mx-4 text-white object-fill py-10 px-3 md:py-24 md:px-10 flex flex-col items-center">
                <DiamondIcon className="w-10 h-10 mb-4 md:w-20 md:h-20"/>
                <h2 className="font-bold text-xl md:text-3xl">Ürün Gruplarımız</h2>
            </div>
            <div className="grid grid-rows-3 mx-4 gap-4 md:grid-cols-3 md:grid-rows-1 mb-12">
                <div className="row relative md:col-span-1 flex items-center justify-center">
                    <div className="absolute-center__text">
                        <div className="flex flex-col items-center">
                            <h3 className="text-white text-center mb-4 text-2xl md:text-xl lg:text-4xl font-bold">Kapılar</h3>
                ...
                <div className="flex flex-col items-center justify-between">
                    ...
                    <div className="absolute-center__text">
                            <div className="flex flex-col items-center">
                                <h3 className="text-white text-center mb-4 text-2xl md:text-xl lg:text-4xl font-bold">Laminantlar</h3>
                                <div className="w-12 h-12 rounded-full border-2 border-white flex items-center justify-center">
                                    <ArrowIcon/>
                                </div>
                        </div>
                    ...
                    <div className="absolute-center__text">
                            <div className="flex flex-col items-center">
                                <h3 className="text-white text-center mb-4 text-2xl md:text-xl lg:text-4xl font-bold">Süpürgelikler</h3>
                                <div className="w-12 h-12 rounded-full border-2 border-white flex items-center justify-center">
                                    <ArrowIcon/>
                                </div>
                        </div>
                ...
                <div className="absolute-center__text">
                        <div className="flex flex-col items-center">
                            <h3 className="text-white text-center mb-4 text-2xl md:text-xl lg:text-4xl font-bold">Lamineler</h3>
                            <div className="w-12 h-12 rounded-full border-2 border-white flex items-center justify-center">
                                <ArrowIcon/>
                            </div>
                    </div>
