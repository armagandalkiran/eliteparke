    ...
    return(
        <div className="mt-28 grid md:mt36 mb-12">
            <div className="bg-header mb-12 h-auto text-white py-10 md:py-24 md:px-10 object-fill">
                <h2 className="text-center text-3xl mb-8 font-bold md:text-4xl md:mb-16">Laminantlar</h2>
                <ul className="flex px-4 items-center justify-evenly text-center md:text-2xl md:px-8">
                    <li>Kaliteli Markalar</li>
                    <DotIcon className="w-2"/>
                    <li>Çizilmez Dayanıklı</li>
                    <DotIcon className="w-2"/>
                    <li>Kolay Temizlik</li>
                    <DotIcon className="w-2"/>
                    <li>Çeşitli Seçenekler</li>
                </ul>
            </div>
            ...
            <div className="grid grid-cols-1 gap-8 p-6 md:grid-cols-4">
                {images.laminant.map((image,index) => {
                    return (
            ...
            <div className="p-6 grid grid-cols-1 gap-8 mt-8 md:grid-cols-5">
                {images.laminantMarka.map((image,index) => {
                    return (
                        <div className="p-4 col-span-1 border border-gray shadow-lg flex items-center justify-center" key={index}>
                        <img className="w-full" alt={`${image.desc}`} src={`${image.url}`}/>
                        </div>          
                    )
                })}
            </div>
