...
export default function Aboutus() {
  return (
    <div className="mt-20 mb-5 p-6 md:p-14 md:mt-36 md:mb-14 flex flex-col items-center md:flex-row md:justify-between">
      <div className="text-customText md:w-1/2">
