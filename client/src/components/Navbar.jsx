  ...
  return (
    <><div className="top-0 fixed bg-white w-full z-10">
        <div className="flex justify-between items-center  text-customText p-6 relative">
          <Link to = "/"><h1 className="text-2xl font-extrabold md:hidden uppercase text-header">Elite Parke</h1></Link>
          ...
          <Link to = "/" className="mr-4"><h1 className="text-4xl font-extrabold uppercase text-header">Elite Parke</h1></Link>
